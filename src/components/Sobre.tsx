  ...
  return (
    <div className="container mx-auto px-4 py-12 bg-white">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-black">Sobre a EducaValestec</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-4 text-black">Certificação Reconhecida</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-semibold mb-4 text-black">Instrutores Especialistas</h2>
            <p className="text-gray-700">
        ...
        <div className="bg-blue-50 p-8 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4 text-black">Nossa Experiência</h2>
          <p className="text-gray-700">
